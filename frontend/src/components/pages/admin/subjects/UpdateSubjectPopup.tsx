...
type Props = {
  refetch: () => void;
  selectedSubjectToUpdate: TSubjectSchemaType;
  setSelectedSubjectToUpdate: Dispatch<
    SetStateAction<TSubjectSchemaType | null>
  >;
};

const UpdateSubjectPopup = ({
  refetch,
  selectedSubjectToUpdate,
  setSelectedSubjectToUpdate,
}: Props) => {
  ...
  const initialValues: TSubjectSchemaType = {
    subjectName: selectedSubjectToUpdate.subjectName,
    subjectCode: selectedSubjectToUpdate.subjectCode,
    subjectDesc: selectedSubjectToUpdate.subjectDesc,
    subjectHours: selectedSubjectToUpdate.subjectHours,
    doctorsNames: selectedSubjectToUpdate.doctorsNames || [],
    book: "",
    year: selectedSubjectToUpdate.year,
    semester: selectedSubjectToUpdate.semester,
  };
            ...
            <div className="flex items-baseline-last gap-2">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  const current = values.doctorsNames ?? [];
