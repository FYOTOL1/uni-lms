...
const HomeAssignmentCard = ({ e }: { e: TAssignmentSchemaType }) => {
    ...
    >
      ...
      <div className="flex justify-between">
        <div className="flex gap-4">
          <div className="flex items-center justify-center size-7 rounded bg-purple-500">
        ...
        <Link
          ...
          to={`/subjects/${e.subject.subjectCode}`}
        >
          {e.subject.subjectCode}
        </Link>
      </div>
